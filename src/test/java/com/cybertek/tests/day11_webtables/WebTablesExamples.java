...
public class WebTablesExamples {
    ...
    public void getAllCellInOneRow(){
        ...
        for (WebElement each:allCellsInOneRow) {
            System.out.println(each.getText());
        }

//        for(int i=1; i<5;i++){
//            List<WebElement> allCellsInOneRow = driver.findElements(By.xpath("//table[@id='table1']/tbody/tr["+i+"]/td"));
//            for (WebElement each:allCellsInOneRow) {
//                System.out.println(each.getText());
//            }
    ...
    public void printAllCellsByIndex(){
        ...
        int colNumber = getNumberOfColoums();
